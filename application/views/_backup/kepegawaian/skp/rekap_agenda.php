				...
				<div class="widget" id="form-chart">
					...
					<div class="widget-content">
						<div class="padd"><form class="form-horizontal" method="post" action="<?php echo base_url('kepegawaian/skp/rekap_agenda/download'); ?>">
							...
							<div class="form-group cnt-biodata">
...
$(document).ready(function() {
	var page = {
		init: function() {
			...
			// set view
			if (! Func.in_array(page.data.user.user_type_id, [page.data.USER_ID_TU, page.data.USER_ID_ADMINISTRATOR])) {
				$('#form-chart .cnt-biodata').hide();
				$('#form-chart [name="biodata_id"]').val(page.data.user.biodata_id);
			}
		}
	}
	page.init();
