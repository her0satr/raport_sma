...
$autoload['model'] = array(
	'user_model', 'discipline_model',
	
	/*
	, 'user_type_model', 'skpd_model', 'biodata_model', 'agama_model', 'jenis_kepegawaian_model', 'status_perkawinan_model',
	...
	'skp_realisasi_model', 'skp_sasaran_kerja_model', 'skp_tugas_tambahan_model', 'perilaku_kerja_model', 'pejabat_model'
	/*	*/
);